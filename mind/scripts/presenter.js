...
function getPresenterPassword() {
    ...
    const tempPass = localStorage.getItem('mind_temp_pass');
    if (tempPass) {
        console.log('INFO: Senha temporária do controller encontrada, movendo para sessionStorage.');
        sessionStorage.setItem('mind_presenter_pass', tempPass);
    ...
    const password = sessionStorage.getItem('mind_presenter_pass');
    if (!password) {
